	...
	<AccordionPrimitive.Header className="flex">
		...
		>
			...
			<div className="group-data-[state=closed]:block group-data-[state=open]:hidden">
				<Plus className="h-4 w-4 md:w-6 md:h-6 shrink-0 text-neutral-500 transition-transform duration-200 dark:text-neutral-400" />
			</div>
			<div className="group-data-[state=open]:block group-data-[state=closed]:hidden">
				<Minus className="h-4 w-4 md:w-6 md:h-6 shrink-0 text-neutral-500 transition-transform duration-200 dark:text-neutral-400" />
			</div>
		</AccordionPrimitive.Trigger>
