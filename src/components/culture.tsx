	...
	return (
		...
		>
			...
			<div className='grid bg-white md:grid-cols-2'>
				<div className='px-8 md:px-[50px] min-h-[250px] md:min-h-[237px] py-10 bg-white text-body-alt md:hover:bg-[#EBFFF1] cursor-pointer flex flex-col gap-5'>
					<Hearts />
					<h2 className='text-primary-dark font-dms-serif font-medium text-2xl md:text-[28px] leading-none'>
						Respect everyone
					</h2>
				...
				<div className='px-8 md:px-[50px] min-h-[250px] md:min-h-[237px] py-10 md:bg-[#EBFFF1] md:hover:bg-[#EBFFF1] text-body-alt flex flex-col cursor-pointer gap-5'>
					<Message />
					<h2 className='text-primary-dark font-dms-serif font-medium text-2xl md:text-[28px] leading-none'>
						Communicate clearly
					</h2>
