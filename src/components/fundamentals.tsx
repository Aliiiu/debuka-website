...
const Fundamentals = () => {
	return (
		...
		>
			<h2 className='text-primary-dark font-semibold text-4xl font-swis'>
				Fundamental Promise
			</h2>
			<p className='text-body-alt mt-3 font-swis'>
				Our fundamentals define our promises to our partners regarding our
				cuisines.
			</p>
			<div className='mt-10'>
				<div className='p-6 font-swis'>
					<AppCarousel data={fundamentals}>
						<div className='flex touch-pan-y pt-5 font-swis'>
							{fundamentals.map((item) => (
								<div
									key={item.id}
									className='min-w-0 flex flex-col items-center gap-5 flex-[0_0_100%] font-swis'
								>
									<Quote />
									<span className='font-semibold z-0 text-grey-800 md:text-lg font-swis'>
										{item.content}
									</span>
								</div>
							))}
