...
const menuItems = [
	{
		...
		description:
			"Leaf-twined red tilapia with Ijebu fish glaze, served with buka stew. Sides sold separately: yam ($12), jollof rice ($12), or peppered plain/boat plantain ($6/$12).",
		price: "C$70",
	},
	{
		...
		price: "C$60",
		description:
			"Herb and citrus-glazed chicken or turkey thigh served with buka stew. Sides sold separately: yam ($12), jollof rice ($12), or peppered plain/boat plantain ($6/$12).",
	},
	{
