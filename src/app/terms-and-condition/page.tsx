			...
			<div className='container flex flex-col md:flex-row gap-10 py-10 md:py-14'>
				...
				<div className='flex-1 flex flex-col gap-10'>
					...
					<section>
						...
						<h3 className='text-header font-bold text-lg'>Definitions</h3><br />
						...
						<ul style={{ listStyleType: 'disc' }}>
							...
							<li>
								<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to deBuka Corporation, 42 Laguna Village Crescent Hannon L0R 1P0.</p>
							</li><br />
							<li>
							...
							<li>
								<p><strong>Website</strong> refers to deBuka, accessible from <a href="https://www.debuka.com" rel="external nofollow noopener" target="_blank">https://www.debuka.com</a></p>
							</li><br />
							<li>
					...
					<section>
						<h2 className='text-header font-bold text-lg'>Acknowledgment</h2><br />
					...
					<section>
						<h2 className='text-header font-bold text-lg'>Links to Other Websites</h2><br />
					...
					<section>
						<h2 className='text-header font-bold text-lg'>Termination</h2><br />
					...
					<section>
						<h2 className='text-header font-bold text-lg'>Limitation of Liability</h2><br />
					...
					<section>
						<h2 className='text-header font-bold text-lg'>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2><br />
					...
					<section>
						<h2 className='text-header font-bold text-lg'>Governing Law</h2><br />
					...
					<section>
						<h2 className='text-header font-bold text-lg'>Disputes Resolution</h2><br />
					...
					<section>
						<h2 className='text-header font-bold text-lg'>For European Union (EU) Users</h2><br />
					...
					<section>
						<h2 className='text-header font-bold text-lg'>United States Legal Compliance</h2><br />
							<p>You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a &quot;terrorist supporting&quot; country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p><br />
					</section>
					<section>
						<h2 className='text-header font-bold text-lg'>Severability and Waiver</h2><br />
						<h3 className='text-header font-bold text-lg'>Severability</h3><br />
					...
					<section>
						<h2 className='text-header font-bold text-lg'>Contact Us</h2><br />
							<p>If you have any questions about these Terms and Conditions, You can contact us:</p><br />
							<ul>
								<li>By email: hello@debuka.com</li>
							</ul>
					</section>
				</div>
			</div>
