		...
		<main className='flex min-h-screen flex-col items-center bg-grey-100'>
			...
			<div className='container flex flex-col md:flex-row gap-10 py-10 md:py-14'>
				...
				<div className='flex-1 flex flex-col gap-10'>
					<h1 className='text-header font-bold text-lg'>Privacy Policy</h1>
					...
					<section>
						<h2 className='text-header font-bold text-lg'>Collecting and Using Your Personal Data</h2><br />
						<h3 className='text-header font-bold text-lg'>Types of Data Collected</h3><br />
						<h4 className='text-header font-bold text-lg'>Personal Data</h4><br />
						...
						<h4 className='text-header font-bold text-lg'>Usage Data</h4><br />
						...
						<h4 className='text-header font-bold text-lg'>Tracking Technologies and Cookies</h4><br />
						...
						<ul style={{ listStyleType: 'disc' }}>
							...
							<p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank">Free Privacy Policy website</a> article.</p><br />
						...
						<h3 className='text-header font-bold text-lg'>Use of Your Personal Data</h3><br />
						...
						<h3 className='text-header font-bold text-lg'>Retention of Your Personal Data</h3><br />
						...
						<h3 className='text-header font-bold text-lg'>Transfer of Your Personal Data</h3><br />
						...
						<h3 className='text-header font-bold text-lg'>Delete Your Personal Data</h3><br />
						...
						<h3 className='text-header font-bold text-lg'>Disclosure of Your Personal Data</h3><br />
						
						<h4 className='text-header font-bold text-lg'>Business Transactions</h4><br />
						...
						<h4 className='text-header font-bold text-lg'>Other legal requirements</h4><br />
						...
						<h3 className='text-header font-bold text-lg'>Security of Your Personal Data</h3><br />
					...
					<section>
						<h2 className='text-header font-bold text-lg'>Children&apos;s Privacy</h2><br />
					...
					<section>
						<h2 className='text-header font-bold text-lg'>Changes to this Privacy Policy</h2><br />
